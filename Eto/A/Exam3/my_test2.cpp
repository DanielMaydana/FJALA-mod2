...
public:
    ...
    // void add(const string& key, const json_array& j_arr)
    // {
    ...
    // return jo.to_string() == "{ \"marca\" : \"volkswagen\", \"modelos\" :
    // [\"jetta\", \"new beetle\", \"golf\"], \"descripcion\" :
    // \"pais\" : \"alemania\", \"produccion_anual\" : 50000 } }";
};
