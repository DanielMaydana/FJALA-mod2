...
class sistema_facturacion
{
    ...
    public:
        ...
        factura& crear_factura(const m_string &nombre, const m_string &nit = "0", const fecha& fe=fecha{});
        array_list obtener_facturas_de_hoy() const;
        const producto& get_producto_por_codigo(const m_string&) const;
        producto& get_producto_por_codigo(const m_string&);
};